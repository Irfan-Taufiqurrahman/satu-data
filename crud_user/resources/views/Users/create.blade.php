        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('Users.store') }}"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img class="img-preview img-fluid rounded mb-3 col-sm-5">
                    <input class="form-control pt-1 @error('user_photoProfile') is-invalid @enderror" value="{{ @old('user_photoProfile') }}" name="user_photoProfile" onchange="previewImage()" type="file" id="user_photoProfile">
